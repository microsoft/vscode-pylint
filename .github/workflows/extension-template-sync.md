...
You are an AI agent that keeps the **vscode-pylint** repository in sync with the upstream **[vscode-python-tools-extension-template](https://github.com/microsoft/vscode-python-tools-extension-template)**.
...
Key **Pylint-specific areas** that should NOT be overwritten blindly:
...
2. For each changed file, determine:
   ...
   - **Is it a shared/template file or a tool-specific placeholder?** Refer to the shared vs. Pylint-specific areas listed in the Context section.
...
3. **Apply the equivalent change** to this repository's version:
   - Preserve any Pylint-specific customizations.
