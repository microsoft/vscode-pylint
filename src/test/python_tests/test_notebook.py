...
def test_notebook_magic_lines_no_syntax_error():
    ...
    ``%load_ext autoreload``, pylint must not report a syntax error for
...
def test_notebook_cross_cell_import_not_flagged_unused():
    ...
    must NOT report W0611:unused-import for cell 0.
    """
    ...
    # The import cell must not receive a W0611 unused-import diagnostic.
